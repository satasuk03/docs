...
description: Register a webhook endpoint URL, choose which events to subscribe to, sign payloads with a secret, and verify delivery with retries and logs.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    {/* TODO: Link target `/integrations/webhooks/event-types` does not exist. Restore link once the page is added. */}
    See the event types reference for the full list and payload schemas.
  </Step>
