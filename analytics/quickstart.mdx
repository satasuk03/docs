...
description: Connect your first data source, model your metrics, and build an interactive analytics dashboard in under fifteen minutes from scratch.
---
...
- Explore charts and visualizations to learn about all available chart types.
