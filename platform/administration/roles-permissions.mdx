...
description: Assign built-in roles, build custom permission sets, and control access to workspaces, projects, and resources with fine-grained RBAC controls.
---
